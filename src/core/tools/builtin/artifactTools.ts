...
import { LLMClient, getLLMConfig, buildRouterFromEnv } from '../../llm/index.js';
...
export const regenerateArtifactTool: ToolDefinition = createTool(
  ...
  async (args: Record<string, unknown>) => {
    ...
    const router = buildRouterFromEnv(basePath);
    const llm = router.isEnabled()
      ? router.getClient('structured.prompt_refinement')
