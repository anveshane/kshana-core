...
// Diverse scene test cases across projects
// Mix of: sci-fi action, mundane slice-of-life, fantasy, multi-character, solo character
const TEST_SCENES: Array<{
  ...
  { label: 'Baker morning scene 1 (domestic quiet)', project: 'quiet_morning_baker_sat-2.kshana', scene_number: 1 },
  { label: 'Elarion scene 1 (fantasy landscape)', project: 'centuries_ago_continent_elarion.kshana', scene_number: 1 },
  { label: 'Runner scene 1 (action/chase)', project: 'story_begins_girl_sprinting.kshana', scene_number: 1 },
  { label: 'Sun scene 1 (Indian drama)', project: 'sun_hadnt_yet_cleared.kshana', scene_number: 1 },
];
...
- Should NOT re-describe character appearance (the reference image provides that)
- Must describe spatial arrangement, actions, and lighting
- Must be a frozen instant — no motion verbs or temporal language

This iteration tested ${failures.totalRuns} DIVERSE scenes (sci-fi reveal, domestic quiet, fantasy landscape, action/chase, Indian drama).
...
- Key rules to preserve: frozen instant (no motion verbs), no narrative commentary, no re-describing references, mandatory lighting.
