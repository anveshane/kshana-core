...
```
VIDEO_PLACER:
- Placement 1: [startTime]-[endTime] | type=[cinematic_realism|stock_footage] | [prompt] | [filename.mp4]
- Placement 2: [startTime]-[endTime] | type=[cinematic_realism|stock_footage] | [prompt] | [filename.mp4]
```
